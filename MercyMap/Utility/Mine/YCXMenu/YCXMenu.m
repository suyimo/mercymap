...
#define kTintColor  [UIColor colorWithRed:1.000 green:1.000 blue:1.000 alpha:1]  //!< 主题颜色
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIPanGestureRecognizer   *panGestureRecongnizer;
        UILongPressGestureRecognizer *longPressGestureRecongnizer;
        
        gestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(singleTap:)];
        swipGestureRecognizer = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(singleTap:)];
        panGestureRecongnizer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(singleTap:)];
        longPressGestureRecongnizer = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(singleTap:)];
